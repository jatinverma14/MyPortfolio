...
const About = () => {
  const [Aboutt, setAboutt] = useState([{description: ""}]);
    ...
    <>
      <div className="aboutContainer">
        ...
        <div className="aboutMepara">
          ...
          <br />
          I am a 4 star coder on Codechef with max rating 1907 and Pupil on
          Codeforces. I got rank 1 in March Long One 2022, Division 4 contest on
          Codechef. I have good knowledge of Data structures and Algorithms.
          <br />
